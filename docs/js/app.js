    ...
    (() => {
        ...
        function formSubmit() {
            ...
            function formSent(form, responseResult = ``) {
                ...
                if (fileTextElement) fileTextElement.classList.remove("_upload");
                if (fileInsertElement) fileInsertElement.textContent = "";
        ...
        function initSliders() {
            ...
            if (document.querySelector(".governance-slider__slider")) new Swiper(".governance-slider__slider", {
                modules: [ Navigation, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (menuSubMenuItem) {
            ...
            function handleSubMenuHover() {
                if (window.matchMedia("(min-width: 769px)").matches) {
                    ...
                    if (isPopupOpen) document.documentElement.classList.add("lock");
                }
            }
        ...
        if (detectTextarea) {
            function handleTextareaInput() {
                if (detectTextarea.value.trim() !== "") detectItem.classList.add("_typed"); else detectItem.classList.remove("_typed");
            }
        ...
        const fileInsertElement = document.querySelector(".form__file-insert");
        if (fileInputCV) fileInputCV.addEventListener("change", (function() {
